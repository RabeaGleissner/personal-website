  ...
  return (
    <section className="til-intro-component">
      <div className="til-intro-component-inner">
        ...
        <p>I'm recording little snippets (or sometimes longer snippets) of what I'm learning for several reasons:</p>
        <ul>
          <li>I've noticed that I retain knowledge better and understand matters better when I explain them to others, which includes writing about them in the style of blog posts</li>
          <li>
            As a reference for myself. Sometimes I remember that I learnt something but forget the exact details.
